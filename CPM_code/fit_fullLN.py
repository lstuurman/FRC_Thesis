...
def run_sim(params):
    ...
    for i,track in enumerate(cell_tracks):
        ...
        np.savetxt('../data/FIT_speedy2/single_7ZOOM/CELL'+fname+'.txt',newtrack)
...
def gridsearch():
    ...
    #l_act = np.array([50,100,200,300,400,500,600,700,800,900,1000,1500,2000])
    l_act = np.array([1000,1100,1200,1300,1400,1600,1700,1800,1900])
    max_act = np.linspace(40,80,21)
